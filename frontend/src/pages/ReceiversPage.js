      ...
      <div className="card" style={{ padding: 0 }}>
        <div className="filter-bar">
          <div className="search-input-wrap">
            <Search className="search-icon-svg" size={18} strokeWidth={2} aria-hidden />
        ...
        <div className="table-container">
          {loading ? (
            ...
            <div className="empty-state"><Inbox className="empty-icon-svg" strokeWidth={1.25} aria-hidden /><p>No receivers found</p></div>
          ) : (
                    ...
                    <td style={{ fontSize: 12 }}>
                      {r.bank_name ? (
                        <>
                          ...
                          <div className="mono" style={{ color: 'var(--text-muted)' }}>{r.bank_account}</div>
                        </>
                      ) : '—'}
                    </td>
                    <td>
