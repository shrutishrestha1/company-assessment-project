...
-- ============================================================
IF NOT EXISTS (SELECT 1 FROM users WHERE email = 'admin@himalremit.local')
BEGIN
    INSERT INTO users (full_name, email, phone, role, is_active)
    VALUES ('System Admin', 'admin@himalremit.local', '+977-9800000000', 'admin', 1);
END
GO
